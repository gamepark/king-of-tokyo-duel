...
use [our template on Github](https://github.com/gamepark/board-king-of-tokyo-duel)
...
- `King Of Tokyo Duel` => `Name of your Game`
- `KingOfTokyoDuel` => `NameOfYourGame`
- `king-of-tokyo-duel` => `name-of-your-game`
...
Once you have one Material type and one Location type, you can start to setup a new game in [KingOfTokyoDuelRules.ts](/rules/src/KingOfTokyoDuelRules.ts)
